"""Canonical deterministic, secret-free SoftwareProject source bundle primitives."""
...
def normalized_path(path: str) -> str:
    ...
    if value in {".", ".."} or value.startswith("../") or "/../" in value or value.startswith("."):
...
def build_bundle(
    ...
    for item in files:
        ...
        if b"BEGIN PRIVATE KEY" in item.content or b"OPERLY_SANDBOX_RUNNER_TOKEN" in item.content:
