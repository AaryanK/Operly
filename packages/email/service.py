...
class EmailService:
    ...
    async def _send(self, envelope: EmailEnvelope) -> None:
        try:
            ...
            logger.warning("Transactional email delivery failed (provider_error=%s)", type(error).__name__)
...
def get_email_service() -> EmailService:
    ...
    if provider_name == "smtp":
        ...
        raise EmailConfigurationError("MAIL_PROVIDER must be configured as smtp or zoho_mail_api")
