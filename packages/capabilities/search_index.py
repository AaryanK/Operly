...
# Small operation-level expansion improves retrieval for the common gap between a
# user's wording and a plugin's vocabulary without any remote embedding call. The
# index is intentionally pluggable so a local ONNX embedding encoder can replace
# this encoder later without changing authorization/discovery contracts.
    ...
    def search(
        ...
        *,
        ...
        for definition in definitions:
            ...
            # Semantic similarity is the primary broad-recall signal; lexical/exact
            # metadata boosts make IDs and well-described operations deterministic.
