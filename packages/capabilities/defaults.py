...
from packages.capabilities.providers import CompanyProvider, MessagingProvider, OperlyAnalyticsProvider, ResearchProvider
...
def bootstrap_builtin_plugins() -> None:
    """Register first-party providers through the universal plugin runtime."""
