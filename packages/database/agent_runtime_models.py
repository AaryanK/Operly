...
class AgentRuntimeRun(Base):
    ...
    grants_reference_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
    verified_observations_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    wait_predicate_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
