...
class CodingToolRegistry:
    ...
    def __init__(self) -> None:
        ...
        tools = [
            ...
            CodingTool("finish", "Finish only after requested source changes are coherent and tests remain present.", {"summary": TEXT, "verification": {"type": "array", "items": TEXT}}, ("summary",), rw, _finish_tool),
