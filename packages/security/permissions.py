...
DEFAULT_ROLE_AUTHORITY: dict[str, set[str]] = {
    ...
    "manager": {
        ...
        "reminders:write", "discord:read", "discord:write", "workflows:read",
        "context:human:read", "context:human:write", "context:tenant:read",
        "context:tenant:write", "context:conversation:read", "context:conversation:write",
        "workspace:read",
        *BUSINESS_READ_PERMISSIONS,
    ...
    "agent": {
        ...
        "discord:read", "discord:write", "model:invoke", "files:process", "computer:execute", "workflows:read",
        "context:human:read", "context:human:write", "context:tenant:read",
        "context:tenant:write", "context:conversation:read", "context:conversation:write",
        "workspace:read",
        *BUSINESS_READ_PERMISSIONS,
    ...
    "employee": {
        ...
        "discord:read", "model:invoke", "files:process", "workflows:read",
        "context:human:read", "context:human:write", "context:tenant:read",
