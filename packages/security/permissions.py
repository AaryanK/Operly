...
KNOWN_PERMISSIONS = frozenset(
    permission
    for permissions in DEFAULT_ROLE_AUTHORITY.values()
...
async def resolve_workspace_permissions(
    db: AsyncSession,
    *,
    tenant_id: str,
    role: str,
) -> set[str]:
    """Resolve the trusted permission set for one workspace membership.

    Workspace-defined roles override built-in defaults. Unknown roles are deny-by-default.
    The model never supplies the tenant or role used here.
    """
