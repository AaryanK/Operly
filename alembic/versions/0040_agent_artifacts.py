...
Revision ID: 0040_agent_artifacts
...
def upgrade():
    ...
    op.create_index("ix_operly_artifacts_scope_kind", "operly_artifacts", ["scope_kind"])
    op.create_index("ix_operly_artifacts_scope_id", "operly_artifacts", ["scope_id"])
    op.create_index("ix_operly_artifacts_tenant_id", "operly_artifacts", ["tenant_id"])
    op.create_index("ix_operly_artifacts_owner_user_id", "operly_artifacts", ["owner_user_id"])
    op.create_index("ix_operly_artifacts_run_id", "operly_artifacts", ["run_id"])
    op.create_index("ix_operly_artifacts_sha256", "operly_artifacts", ["sha256"])
    op.create_index("ix_operly_artifacts_expires_at", "operly_artifacts", ["expires_at"])
    op.create_index("ix_operly_artifact_scope_created", "operly_artifacts", ["scope_kind", "scope_id", "created_at"])
    op.create_index("ix_operly_artifact_scope_sha", "operly_artifacts", ["scope_kind", "scope_id", "sha256"])
...
def downgrade():
    ...
    op.drop_table("operly_artifacts")
