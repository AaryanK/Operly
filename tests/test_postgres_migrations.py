...
class PostgreSQLMigrationTests(unittest.TestCase):
    ...
    def test_fresh_and_already_current_idempotency(self):self.upgrade();self.upgrade();self.assertEqual(revisions(URL)[0],"0005_custom_software_vertical_slice")
    ...
    def test_unsafe_orphan_rolls_back_and_never_claims_head(self):
        ...
        self.assertNotEqual(revisions(URL)[0],"0005_custom_software_vertical_slice")
