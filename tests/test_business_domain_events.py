...
def test_verified_capability_wakes_workflow_that_mixes_software_and_internal_plugins():
    async def scenario():
        bootstrap_builtin_plugins()
        manifests = default_plugin_runtime().manifests
                ...
                "steps": [
                    {
                        "id": "inspect_solution",
                        "type": "invoke",
                        "capability": "software.build.status",
                    ...
                    },
                    {
                        ...
                        "arguments": {"message": "$inspect_solution.build_state"},
                    },
                ]
            }
        )
        capabilities = _invoke_capabilities(workflow)
        assert capabilities == {"software.build.status", "discord.send_dm"}
