...
type SettingsTab = "account" | "connections" | "security" | "workspaces";
type Props = {
...
export function AccountSettings({ profile, workspaces, initialTab = "account", onClose, onRefresh, onWorkspace }: Props) {
  ...
  const heading = tab === "account" ? "My account" : tab === "connections" ? "Personal connections" : tab === "security" ? "Password & security" : "Your workspaces";
